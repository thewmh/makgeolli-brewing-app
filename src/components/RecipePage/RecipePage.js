        ...
        return (
            <div>
                ...
                {this.props.reduxState.recipes.recipe.map(recipe => (
                    ...
                    {this.props.reduxState.user.id ? <button className="add-recipe-btn" onClick={this.addRecipeToUserLibrary(this.props.reduxState.recipes.recipe[0].id)}>Add this recipe to your library</button> : <></>}
                    </div>
